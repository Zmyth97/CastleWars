...
public class Deck {
    ...
    private void fillDeck(){
        ...
        for(int i = 0; i < Settings.SABOTAGE_AMOUNT; i++){
            cardList.add(new Card(Assets.cardBlank, Card.BUILD, CardActions.SABOTAGE, CardActions.SABOTAGE_COST, GameWorld.DRAW_PILE_X, GameWorld.DRAW_PILE_Y));
        }
        for(int i = 0; i < Settings.STRONGHOLD_AMOUNT; i++){
            cardList.add(new Card(Assets.cardBlank, Card.BUILD, CardActions.STRONGHOLD, CardActions.STRONGHOLD_COST, GameWorld.DRAW_PILE_X, GameWorld.DRAW_PILE_Y));
        }

        //ATTACK CARDS
        for(int i = 0; i < Settings.RECRUITER_AMOUNT; i++){
            cardList.add(new Card(Assets.cardBlank, Card.ATTACK, CardActions.RECRUITER, CardActions.RECRUITER_COST, GameWorld.DRAW_PILE_X, GameWorld.DRAW_PILE_Y));
        }
        for(int i = 0; i < Settings.SPEARMAN_AMOUNT; i++){
            cardList.add(new Card(Assets.cardBlank, Card.ATTACK, CardActions.SPEARMAN, CardActions.SPEARMAN_COST, GameWorld.DRAW_PILE_X, GameWorld.DRAW_PILE_Y));
        }
        for(int i = 0; i < Settings.RAM_AMOUNT; i++){
            cardList.add(new Card(Assets.cardBlank, Card.ATTACK, CardActions.RAM, CardActions.RAM_COST, GameWorld.DRAW_PILE_X, GameWorld.DRAW_PILE_Y));
        }
        for(int i = 0; i < Settings.CATAPULT_AMOUNT; i++){
            cardList.add(new Card(Assets.cardBlank, Card.ATTACK, CardActions.CATAPULT, CardActions.CATAPULT_COST, GameWorld.DRAW_PILE_X, GameWorld.DRAW_PILE_Y));
        }
        for(int i = 0; i < Settings.LEGION_AMOUNT; i++){
            cardList.add(new Card(Assets.cardBlank, Card.ATTACK, CardActions.LEGION, CardActions.LEGION_COST, GameWorld.DRAW_PILE_X, GameWorld.DRAW_PILE_Y));
        }
        for(int i = 0; i < Settings.TREBUCHET_AMOUNT; i++){
            cardList.add(new Card(Assets.cardBlank, Card.ATTACK, CardActions.TREBUCHET, CardActions.TREBUCHET_COST, GameWorld.DRAW_PILE_X, GameWorld.DRAW_PILE_Y));
        }
